...
namespace KlayGE
{
	...
	D3D11RenderTargetRenderView::D3D11RenderTargetRenderView(TexturePtr const & texture, ElementFormat pf, int first_array_index,
	...
	D3D11RenderTargetRenderView::D3D11RenderTargetRenderView(TexturePtr const & texture_3d, ElementFormat pf, int array_index,
	...
	D3D11RenderTargetRenderView::D3D11RenderTargetRenderView(TexturePtr const & texture_cube, ElementFormat pf, int array_index,
	...
	D3D11RenderTargetRenderView::D3D11RenderTargetRenderView(GraphicsBufferPtr const & gb, ElementFormat pf, uint32_t first_elem,
		uint32_t num_elems)
	...
	D3D11DepthStencilRenderView::D3D11DepthStencilRenderView(TexturePtr const & texture, ElementFormat pf, int first_array_index,
		int array_size, int level)
		: rt_src_(texture.get()), rt_first_subres_(first_array_index * texture->NumMipMaps() + level), rt_num_subres_(1)
	{
		tex_ = texture;
	...
	D3D11DepthStencilRenderView::D3D11DepthStencilRenderView(TexturePtr const & texture_3d, ElementFormat pf, int array_index,
		uint32_t first_slice, uint32_t num_slices, int level)
		: rt_src_(texture_3d.get()), rt_first_subres_((array_index * texture_3d->Depth(level) + first_slice) * texture_3d->NumMipMaps() + level), rt_num_subres_(num_slices * texture_3d->NumMipMaps() + level)
	{
		tex_ = texture_3d;
	...
	D3D11DepthStencilRenderView::D3D11DepthStencilRenderView(TexturePtr const & texture_cube, ElementFormat pf, int array_index,
		Texture::CubeFaces face, int level)
		: rt_src_(texture_cube.get()), rt_first_subres_((array_index * 6 + face) * texture_cube->NumMipMaps() + level), rt_num_subres_(1)
	{
		tex_ = texture_cube;
